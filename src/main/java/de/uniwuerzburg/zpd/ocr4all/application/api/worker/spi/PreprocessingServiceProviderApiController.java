/**
 * File:     PreprocessingServiceProviderApiController.java
...
/**
 * Defines preprocessing service provider controllers for the api.
 *
...
public class PreprocessingServiceProviderApiController extends ServiceProviderCoreApiController<PreprocessingService> {
	 ...
	 * The context path.
	 */
	public static final String contextPath = spiContextPathVersion_1_0 + "/preprocessing";

	/**
	 * Creates a preprocessing service provider controller for the api.
	 * 
	 ...
	 */
	@Autowired
	public PreprocessingServiceProviderApiController(ConfigurationService configurationService,
			SecurityService securityService, ProjectService projectService, WorkflowService workflowService,
			SchedulerService schedulerService, PreprocessingService service) {
		super(PreprocessingServiceProviderApiController.class, configurationService, securityService, projectService,
				workflowService, schedulerService, Type.preprocessing, service, Project.Right.execute);
	}
