/**
 * File:    ToolServiceProviderApiController.java
...
/**
 * Defines tool service provider controllers for the api.
 *
...
public class ToolServiceProviderApiController extends ServiceProviderCoreApiController<ToolService> {
	 ...
	 * The context path.
	 */
	public static final String contextPath = spiContextPathVersion_1_0 + "/tool";

	/**
	 * Creates a tool service provider controller for the api.
	 * 
