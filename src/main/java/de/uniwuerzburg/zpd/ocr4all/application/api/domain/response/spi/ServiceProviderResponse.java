...
import de.uniwuerzburg.zpd.ocr4all.application.api.worker.spi.ProcessServiceProviderApiController;
...
public class ServiceProviderResponse implements Serializable {
	 ...
	 * The type.
	 */
	private ProcessServiceProviderApiController.Type type;
	 ...
	 * @since 1.8
	 */
	public ServiceProviderResponse(Locale locale, ProcessServiceProviderApiController.Type type, String id,
	 ...
	 * @since 1.8
	 */
	public ProcessServiceProviderApiController.Type getType() {
		return type;
	}
	 ...
	 * @since 1.8
	 */
	public void setType(ProcessServiceProviderApiController.Type type) {
		this.type = type;
	}
