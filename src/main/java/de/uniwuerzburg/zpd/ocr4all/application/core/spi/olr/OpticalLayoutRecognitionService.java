 ...
 */
@Service
public class OpticalLayoutRecognitionService
		extends CoreServiceProvider<OpticalLayoutRecognitionServiceProvider> {
	/**
	...
	public OpticalLayoutRecognitionService(ConfigurationService configurationService) {
		super(OpticalLayoutRecognitionService.class, configurationService,
				OpticalLayoutRecognitionServiceProvider.class);
	}
