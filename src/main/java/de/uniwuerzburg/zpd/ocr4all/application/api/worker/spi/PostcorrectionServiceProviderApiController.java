/**
 * File:     PostcorrectionServiceProviderApiController.java
...
/**
 * Defines post-correction service provider controllers for the api.
 *
 ...
 */
@Profile("api")
@Tag(name = "SPI post-correction", description = "the post-correction service provider API")
@RestController
...
public class PostcorrectionServiceProviderApiController
	 ...
	 * The context path.
	 */
	public static final String contextPath = spiContextPathVersion_1_0 + "/postcorrection";

	/**
	 * Creates a post-correction service provider controller for the api.
	 * 
